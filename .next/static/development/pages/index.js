...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=C%3A%5Cdev%5Cnodejs%5Capp-chat-js%5Cpages%5Cindex.js!./":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=C%3A%5Cdev%5Cnodejs%5Capp-chat-js%5Cpages%5Cindex.js ***!
  \*****************************************************************************************************************************************************************/
/*! no static exports found */
...
var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_2___default()('localhost:3000');
...
function Index() {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])([]),
      mensagemServidor = _useState3[0],
      setMensagemServidor = _useState3[1];

  socket.on('now', function (status) {
    if (status) {
      console.log(status);
      setStatus(status);
    }
  });
  socket.on('mensagem', function (mensagemServidor) {
    console.log(mensagemServidor);
    setMensagemServidor(mensagemServidor);
  });
  socket.on('novo', function (mensagemServidor) {
    console.log(mensagemServidor);
  });

  var sendMessege = function sendMessege(e) {
    setMensagemServidor([].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(mensagemServidor), [mensagem]));
    socket.emit('mensagem', mensagem);
  };

  return __jsx("div", null, __jsx("h3", null, "Status: ", __jsx("b", null, status)), __jsx("ul", null, mensagemServidor.map(function (mensagem) {
    return __jsx("li", null, mensagem);
  })), __jsx("input", {
    type: "text",
    value: mensagem,
...
/***/ 2:
/*!*********************************************************************************************************************!*\
  !*** multi next-client-pages-loader?page=%2F&absolutePagePath=C%3A%5Cdev%5Cnodejs%5Capp-chat-js%5Cpages%5Cindex.js ***!
  \*********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! next-client-pages-loader?page=%2F&absolutePagePath=C%3A%5Cdev%5Cnodejs%5Capp-chat-js%5Cpages%5Cindex.js! */"./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=C%3A%5Cdev%5Cnodejs%5Capp-chat-js%5Cpages%5Cindex.js!./");
